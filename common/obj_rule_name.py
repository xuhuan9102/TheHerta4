...
class ObjRuleName:
	def __init__(self, obj_name: str):
		...
		self.draw_ib: str = ""
		self.index_count: str = ""
		self.first_index: str = ""
		self.obj_alias_name: str = ""

		self.objname_parse_error_tips: str = "Obj名称规则为: DrawIB-IndexCount-FirstIndex.AliasName,例如[67f829fc-2653-0.头发]第一个.前面的内容要符合规则,后面出现的内容是可以自定义的"
