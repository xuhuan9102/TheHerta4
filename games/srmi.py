...
class ExportSRMI:
    ...
    def __post_init__(self):
        self.drawib_model_list = ExportHelper.parse_drawib_model_list_from_blueprint_model(blueprint_model=self.blueprint_model,combine_ib=True)
